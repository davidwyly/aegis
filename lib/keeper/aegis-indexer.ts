    ...
    try {
      ...
      switch (decoded.eventName) {
        ...
        case "AppealPanelSeated": {
          await applyStatusUpdate(cfg, decoded.args.caseId, "appeal_open")
          break
        }
        case "AppealUpheld":
        case "AppealOverturned": {
          // Both upheld and overturned eventually emit CaseResolved with
          // the final verdict — that handler will sweep up the median +
          // resolutionTxHash. Nothing case-specific to do here.
          break
        }
